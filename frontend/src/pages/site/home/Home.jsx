  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className=" text-white bg-black text-center py-2 text-sm">
        ...
        <button className="absolute right-4 top-1 text-white text-lg">×</button>
      </div>

      {/* Header */}
      <header className="border-b">
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
          <div className="text-4xl font-extrabold">SHOP.CO</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-8 mb-8">
            <div className="md:col-span-2">
              ...
              <div className="flex gap-4">
                <button className="border rounded-full p-2 hover:bg-white">
                  f
                </button>
                <button className="border rounded-full p-2 hover:bg-white bg-black text-white">
                  𝕏
                </button>
                <button className="border rounded-full p-2 hover:bg-white">
                  in
